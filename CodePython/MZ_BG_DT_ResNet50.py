...
#                                                    batch_size=batch_size)
# #  Preprocessing 
# resnet = ResNet50(input_shape=(img_height,img_with,3), weights='imagenet', include_top=False)
...
# model.save('G:/1510815/ML and DL/Data/ResNet50_first_model')

model=keras.models.load_model('G:/1510815/ML and DL/Data/ResNet50_first_model')
